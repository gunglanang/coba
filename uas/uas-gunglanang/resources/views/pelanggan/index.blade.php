                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('pelanggan.store') }}">
                        ...
                        <div>
                            ...
                            <select id="tarif_id" class="block mt-1 w-full" name="tarif_id" required autofocus>>
                                @foreach($tarif as $item)
                                    <option value="{{ $item->id }}">Daya {{$item->daya}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mt-4">
                            ...
                            <x-input id="meter_no" class="block mt-1 w-full" type="number" name="meter_no" :value="old('meter_no')" required autofocus />
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="address" class="block mt-1 w-full" name="address" required autofocus></textarea>
                        </div>
